...
fn parse_while_statement() {
    ...
    let while_statement = body_node.children()[0];
    ...
    let condition = while_node.children()[0];
...
fn parse_while_statement_with_binary_condition() {
    ...
    let assignment = while_body_node.children()[0];
...
fn parse_while_statement_with_break_and_continue() {
    ...
    assert_eq!(while_body_node.children().len(), 3);

    let first_if = while_body_node.children()[0];
    let second_if = while_body_node.children()[1];
    let tick_statement = while_body_node.children()[2];
    ...
    let first_if_block = syntax.node(first_if).unwrap().children()[1];
    let first_if_block_node = syntax.node(first_if_block).unwrap();

    let continue_statement = first_if_block_node.children()[0];
    ...
    let second_if_block = syntax.node(second_if).unwrap().children()[1];
    let second_if_block_node = syntax.node(second_if_block).unwrap();

    let break_statement = second_if_block_node.children()[0];
